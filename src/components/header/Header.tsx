      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            {/* Notification — hanya tampil jika login */}
          ...
          {isLoggedIn ? (
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600 transition-colors dark:bg-brand-500 dark:hover:bg-brand-600"
            >
              <svg
                width="16"
                height="16"
